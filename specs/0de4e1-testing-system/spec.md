...
New skill following superpowers format that documents (use the writing-skills metaskill from superpowers):
...
- `writing-skills` metaskill from superpowers (for writing the testing skill)
