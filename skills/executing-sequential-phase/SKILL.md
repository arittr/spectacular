...
### Step 2: Extract Phase Context (Before Dispatching)
...
7. Create stacked branch (CRITICAL - Stage THEN create):
   a) git add .
...
### Step 4: Verify Natural Stack Formation
...
### Step 5: Code Review (Binary Quality Gate)
